...
import { getCourseAnalytics } from "@/service/analytics/admin-analytics.service";

const coursesQuerySchema = dateRangeSchema.and(
  z.object({
 ...
 * Platform course performance analytics.
 */
export async function GET(request: Request) {
  try {
    ...
    const { data, dateRange } = await getCourseAnalytics(parsed.data);
