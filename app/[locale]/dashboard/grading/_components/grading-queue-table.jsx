...
/**
 * Renders a paginated list of pending-grading attempts. Each row links to the
 * grade-response page for that attempt. Server-side passes already-serialized
 * `items` (plain objects).
 */
export function GradingQueueTable({ items, total, page, limit, basePath }) {
